...
const Sidebar = ({ suggestionCategories, filterCategories, statuses, originalSuggestions }) => {
    ...
    return <aside className="sidebar fixed sm:static left-0 sm:left-[unset] max-w-full lg:max-w-[255px] lg:sticky lg:top-0 w-full flex flex-col sm:grid sm:grid-cols-3 lg:flex flex-row lg:flex-col gap-0 sm:gap-6">
        ...
        <div className={`gap-6 ${windowWidth < 640 & mobileMenuOpen ? "flex bg-pale-blue p-6 gap-6 max-w-[272px] self-end" : "hidden"} flex-col sm:flex-row sm:col-start-2 sm:col-end-4 sm:grid sm:grid-cols-2 lg:flex lg:flex-col`}>
            <FeedbackFilters 
